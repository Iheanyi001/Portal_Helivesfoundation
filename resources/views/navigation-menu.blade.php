<nav class="side-nav">
    <a href="#" class="intro-x flex items-center pl-5 pt-4">
        <img alt="Midone - HTML Admin Template" class="w-6" src="{{ asset('assets/images/logo.png') }}">
        <span class="hidden xl:block text-white text-lg ml-3"> He Lives</span>
    </a>
    ...
    <ul>
        ...
        <li>
            <a href="javascript:;" class="side-menu {{ request()->routeIs('exam.*') ? 'side-menu--active': ''}}">
            ...
            <ul class="{{ request()->routeIs('exam.*') ? 'side-menu__sub-open':'' }}">
                <li>
                    <a href="{{ route('exam.list') }}" class="side-menu {{ request()->routeIs('exam.list') ? 'side-menu--active' :'' }}">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title">Exam List</div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('exam.create') }}" class="side-menu {{ request()->routeIs('exam.create') ? 'side-menu--active' :'' }}">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title"> Create Exam</div>
                    </a>
                </li>

                <li>
                    <a href="{{ route('exam.question.create') }}" class="side-menu {{ request()->routeIs('exam.question.create') ? 'side-menu--active' :'' }}">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title"> Create Question</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:;" class="side-menu {{ request()->routeIs('user.*') ? 'side-menu--active': ''}}">
            ...
            <ul class="">
                <li>
                    <a href="side-menu-light-users-layout-1.html" class="side-menu {{ request()->routeIs('user.list') ? 'side-menu--active' :'' }}">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title"> User List </div>
                    </a>
                </li>
                <li>
                    <a href="side-menu-light-users-layout-2.html" class="side-menu {{ request()->routeIs('user.create') ? 'side-menu--active' :'' }}">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
        ...
        <li>
            <a href="{{ route('profile.show') }}" class="side-menu {{ request()->routeIs('profile.show') ? 'side-menu--active': ''}}">
